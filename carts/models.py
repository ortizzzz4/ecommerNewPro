...
class Cart(models.Model):
     ...
     def products_related(self): # objetos obteniendo
...
def set_cart_id(sender, instance, *args, **kwargs):
         if not instance.cart_id:
             instance.cart_id = str(uuid.uuid4()) #instance.generate_cart_id()

def update_totals(sender, instance, action, *args, **kwargs): #colbas 
