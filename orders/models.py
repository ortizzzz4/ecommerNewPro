...
from biling_profiles.models import BilingProfile
from shipping_addresses.models import ShippingAddress

from .commo import OrderStatus
from .commo import choices
...
class Order(models.Model):
    ...
    promo_code = models.OneToOneField(PromoCode, null=True, blank=True,
                                        on_delete=models.CASCADE)
    billing_profile = models.ForeignKey(BilingProfile, null=True, blank=True,
                                        on_delete=models.CASCADE)
    ...
    def get_or_set_billing_profile(self):
        ...
        biling_profile = self.user.biling_profile
        if biling_profile:
            self.update_billing_profile(biling_profile)

        return biling_profile
